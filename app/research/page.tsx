      ...
      <div className="w-[80%] m-auto py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            SmsGlobe is dedicated to advancing the field of virtual
            verification. Our research focuses on improving security, privacy,
            and user experience. Here are some of our key findings and studies.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <p className="mt-2 text-gray-600">
              ...
              using virtual verification services, ensuring personal data
              remains protected.
            </p>
            <a
