      ...
      <div className="w-[80%] m-auto py-16 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            At SmsGlobe, we provide innovative virtual verification solutions
            that are designed to meet the security needs of the digital world.
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16">
          ...
          <div className="bg-white border rounded-lg p-8 text-center">
            ...
            <p className="mt-4 text-gray-600">
              Benefit from continuous protection with regular updates and
              enhanced features designed to keep your information safe.
            </p>
          </div>
        </div>
