        ...
        <div className="mt-16 space-y-8">
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <p className="mt-2 text-gray-600">
              ...
              platform, and you will instantly get access to virtual
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <p className="mt-2 text-gray-600">
              Virtual verification allows you to verify your identity online
              using secure and temporary methods without revealing your personal
              information.
            </p>
          </div>
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <p className="mt-2 text-gray-600">
              Yes, we prioritize your privacy and security. Our platform uses
              the latest encryption technologies to ensure your data is always
              protected.
            </p>
          </div>
