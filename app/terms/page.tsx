    ...
    <div className="terms-container">
      ...
      <ul>
        ...
        <li>
          ...
          this Agreement) refers to Smsglobe.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Smsglobe, accessible from
      ...
      <ul>
        <li>By email: support@smsglobe.net</li>
        <li>
          By visiting this page on our website: https://www.smsglobe.net/contact
        </li>
