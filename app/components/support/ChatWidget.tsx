  ...
  if (!isOpen && !isFullPage) {
    return (
      <button
        ...
        className="fixed bottom-28 right-6 md:bottom-10 md:right-10 bg-blue-500 text-white p-3 md:p-4 rounded-full shadow-lg hover:bg-blue-600 transition-colors z-50 flex items-center"
